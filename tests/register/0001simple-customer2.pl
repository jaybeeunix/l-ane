#0001simple-customer2.pl

pass('0001simple-customer2.pl');

my $last = lastSale('5678');
ok($sale->open($last), 'open the sale');
#diag(Dumper($sale));
checkFld('id', $last);
checkFld('customer', '5678');
#checkFld('tranzDate', '');
checkFld('suspended', '0', 1);
checkFld('clerk', '100', 1);
checkFld('taxMask', '32767', 1);
checkFld('total', '10675', 1);
...
checkFld('allTaxes', 675, 1);
checkFld('ratranz', 0, 1);
checkFld('change', 0, 1);
checkFld('due', 0, 1);
checkFld('subt', 10000, 1);

checkSubFld('items', 0, 'plu', '1');
...
checkSubFld('taxes', 0, 'tax', 625, 1);
checkSubFld('taxes', 0, 'taxable', 10000, 1);
checkSubFld('taxes', 0, 'taxId', 1, 1);
checkSubFld('taxes', 1, 'id', $last, 1);
checkSubFld('taxes', 1, 'rate', '0.5000');
checkSubFld('taxes', 1, 'tax', 50, 1);
checkSubFld('taxes', 1, 'taxable', 10000, 1);
...
checkSubFld('tenders', 0, 'amt', 10675, 1);

#0003event-error-correct-outoforder.pl

pass('0003event-error-correct-outoforder.pl');
...
checkFld('change', 0, 1);
checkFld('due', 0, 1);
checkFld('subt', 15100, 1);

checkSubFld('items', 0, 'plu', '4');
checkSubFld('items', 0, 'lineNo', 0, 1);
checkSubFld('items', 0, 'id', $last, 1);
checkSubFld('items', 0, 'qty', '1', 1);
checkSubFld('items', 0, 'amt', 100, 1);
checkSubFld('items', 0, 'struck', 1, 1);

checkSubFld('items', 1, 'plu', '4');
checkSubFld('items', 1, 'lineNo', 1, 1);
checkSubFld('items', 1, 'id', $last, 1);
checkSubFld('items', 1, 'qty', '1', 1);
checkSubFld('items', 1, 'amt', 100, 1);
checkSubFld('items', 1, 'struck', 0, 1);

checkSubFld('items', 2, 'plu', '2');
checkSubFld('items', 2, 'lineNo', 2, 1);
checkSubFld('items', 2, 'id', $last, 1);
checkSubFld('items', 2, 'qty', '1', 1);
checkSubFld('items', 2, 'amt', 15000, 1);
checkSubFld('items', 2, 'struck', 0, 1);
...
checkSubFld('tenders', 0, 'amt', 15100, 1);
